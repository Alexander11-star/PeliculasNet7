...
namespace ApiPeliculas.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public UsuarioRepositorio(ApplicationDbContext bd, IConfiguration config, RoleManager<IdentityRole> roleManager, 
            UserManager<AppUsuario> userManager, IMapper mapper)
        {
            _bd = bd;
        ...
        public async Task<UsuarioDatosDto> Registro(UsuarioRegistroDto usuarioRegistroDto)
        {
            ...
            if(result.Succeeded)
            {
                ...
                //await _userManager.AddToRoleAsync(usuario, "admin"); //Se ejecuta la primer ves para crear un rol y se comenta el de abajo
        ...
        public async Task<UsuarioLoginRespuestaDto> Login(UsuarioLoginDto usuarioLoginDto)
        {
            ...
            //Validamos si el usuario no existe con la combinacion de usuario y contraseña correcto
